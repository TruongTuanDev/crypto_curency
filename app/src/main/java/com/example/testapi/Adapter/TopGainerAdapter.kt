...
class TopGainerAdapter(private var lDataItems: List<DataItem>,private val itemClickListener: ItemClickListener) : RecyclerView.Adapter<TopGainerAdapter.TopGainerViewHolder>(){

    inner class TopGainerViewHolder(private val binding: ItemCoinBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopGainerViewHolder {
        ...
        return TopGainerViewHolder(view)
    }
