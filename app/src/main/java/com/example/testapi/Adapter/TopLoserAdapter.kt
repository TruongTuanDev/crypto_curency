...
class TopLoserAdapter(private var lDataItems: List<DataItem>,private val itemClickListener: ItemClickListener) : RecyclerView.Adapter<TopLoserAdapter.TopLoserViewHolder>(){

    inner class TopLoserViewHolder(private val binding: ItemCoinBinding) : RecyclerView.ViewHolder(binding.root) {
